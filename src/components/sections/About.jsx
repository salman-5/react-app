    ...
    <>
      <div className="grid lg:grid-cols-2 grid-cols-1 bg-bg-gray px-8">
        ...
        <div className="flex flex-col h-full items-content-center">
          ...
          <ul className="max-w-md space-y-1 pt-3 text-gray-500 list-inside dark:text-gray-400">
{data['Why Choose Us'].map((x) => {
  return (
    <li key={x} className="ptext flex items-center">
              <svg className="w-3.5 h-3.5 me-2 text-green-500 dark:text-green-400 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="black" viewBox="0 0 20 20">

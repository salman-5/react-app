...
export default function Contact() {
  return (
    <div className="w-full">
      <h2 class="pt-10 underline underline-offset-8 decoration-amber-400 mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-black">
        Contact Us
      </h2>
      <p class="px-8 lg:mb-16 font-light text-center text-gray-900 dark:text-white sm:text-xl">

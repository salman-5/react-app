...
export default function Contact() {
    ...
    return (
        <div>
            ...
            <p class=" lg:mb-16 font-light text-center text-gray-900 dark:text-gray-400 sm:text-xl">Got a technical issue? Want to send feedback about a beta feature? Need details about our Business plan? Let us know.</p>
            <div className="grid grid-cols-2 gap-3">
                <div className=" flex flex-col m-8 place-content-between gap-[11px]">
                    ...
                    <div class='shadow-lg flex flex-col bg-gray-100 w-full h-full place-content-center content-center justify-center mx-auto items-center rounded-xl p-8 space-y-1'>
            ...
            <p className='mx-auto text-justify text-black text-s justify font-Open-sans'>
            EMITAl Aluminum Co LLC. PB No. 18149, Ajman, UAE
            </p>
        </div>
                    </div>
                    <div className="h-1/4 flex flex-row gap-3">
                        <ContactCard icon={contact} title="Email Us" text="info@emital.com" />
                        <ContactCard icon={mail} title="Call Us" text="+971 67486755" />
                    </div>
                </div>
                <Form />

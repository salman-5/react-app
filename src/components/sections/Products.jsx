    ...
    <>
      <div className=" bg-gray-300">
        ...
        <div className="  grid grid-flow-col spacing-x-4 gap-4 ">
          ...
          <div className="  grid grid-flow-col spacing-x-4 ">
            {/* <div className="  w-10 h-full flex lg:w-20 opacity-50 bg-emerald-500 rounded-br-full rounded-tr-full place-items-center  justify-center ">

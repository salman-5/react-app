...
const ScrollToTop= () => {
  ...
  return (
    <div className='fixed w-[30px] h-[30px] bottom-10  right-10 inline-block rounded-full uppercase leading-normal transition duration-150 ease-in-out hover:bg-danger-600 '>

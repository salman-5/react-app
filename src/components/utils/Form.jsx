        ...
        <>
            ...
            <form onSubmit={sendMail} action="#" class="flex flex-col m-8 p-8 space-y-5 bg-slate-500 rounded-[30px] justify-between place-items-center content-between place-content-between">
                ...
                <div className="flex flex-col  justify-center gap-2 ">
                    ...
                    <input type="submit" value="Send message" class="mx-auto rounded-full bg-orange-900 justify-center py-3 px-5 text-sm font-medium text-center text-white  bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" />
